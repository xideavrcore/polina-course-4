...
|
<a href="newcomment.php?note=<?php echo $note_id; ?>">Добавить комментарий</a>
</p>
<?php
echo "<hr>";
...
?>
<a href="deletecomment.php?comment=<?php echo $comment['id']; ?>&note=<?php echo $note_id; ?>">Удалить комментарий</a>
<br><br>
<?php
    }
} else {
